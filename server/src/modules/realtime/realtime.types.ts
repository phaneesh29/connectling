...
export interface ClientToServerEvents {
  ...
  'signal:offer': (payload: { roomCode: string; toUserId: string; offer: unknown }) => void;
  'signal:answer': (payload: { roomCode: string; toUserId: string; answer: unknown }) => void;
  'signal:ice-candidate': (payload: { roomCode: string; toUserId: string; candidate: unknown }) => void;
  'media:state': (payload: {
    roomCode: string;
    isMuted: boolean;
    isVideoOn: boolean;
...
export interface ServerToClientEvents {
  ...
  'signal:offer': (payload: { fromUserId: string; offer: unknown }) => void;
  'signal:answer': (payload: { fromUserId: string; answer: unknown }) => void;
  'signal:ice-candidate': (payload: { fromUserId: string; candidate: unknown }) => void;
