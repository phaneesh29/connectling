...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-4 sm:p-6 bg-black ambient-glow-meet">
        ...
        {isPending ? (
          ...
          <div className="space-y-4 pt-2 relative z-10">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#fcfdff] hover:bg-[#f1f7fe] text-black font-medium rounded-lg transition-all shadow-[0_0_24px_rgba(252,253,255,0.15)] text-xs active:scale-[0.98]"
            >
