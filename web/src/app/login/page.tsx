        ...
        {isPending ? (
          ...
          <div className="space-y-4 pt-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-750 font-medium rounded-xl transition-all shadow-sm text-sm text-zinc-800 dark:text-zinc-100 active:scale-[0.99]"
            >
